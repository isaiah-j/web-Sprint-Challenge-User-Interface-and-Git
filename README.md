...
Semantic HTML is designed to give your HTML meaning to make it more readable. It's also helpful for screenreaders making your site more accessible.

2. Name two big differences between ```display: block;``` and ```display: inline;```.
block elements stack on top while inline elements sit beside each other
...
Git allows developers to easily communicate changes in a codebase
